-- ********************************************************************************************************
--  filename: bloat_analysis.sql
--  version(s): 11, 12, 13, 14
--  preReqs: none
--  source: source: https://www.citusdata.com/blog/2017/10/20/monitoring-your-bloat-in-postgres/
-- ********************************************************************************************************
--
--  Results:  show table and index bloating for a specific database (connect to database before executing)
--
-- ********************************************************************************************************
--
-- table bloat:
